  ...
  return (
    <div>
      ...
      <motion.main initial={{x:-100,opacity:0}} animate={{x:0,opacity:1}} transition={{duration:1,ease:"easeOut"}}>
        <header>
        <nav className="bg-black flex justify-center font-mono py-5 pr-5 pl-56 text-white opacity-70 items-center lg:text-xl md:text-lg sm:px-5 sm:py-5 md:px-5 md:py-5 lg:px-5">
