  ...
  return (
    <div>
      ...
      <nav className="bg-zinc-950 flex justify-between font-mono px-5 py-5 text-white pb-5">
        <div className="primary-nav font-extrabold text-xl">
          Portfolio
        </div>
        <div className="flex gap-5">
          ...
          <div className="p-2 hover:bg-white rounded-md hover:text-black"><Link to="/contact" className="group-hover:text-black px-2">Contact Me</Link></div>
        </div>
      </nav>
    </header>}
    </div>
