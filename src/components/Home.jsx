        ...
        <motion.main initial={{x:-100,opacity:0}} animate={{x:0,opacity:1}} transition={{duration:1,ease:"easeOut"}}>
          <main className=" text-white h-screen px-3 ">
            <div className="flex flex-col justify-center items-center gap-36 pt-24 lg:gap-48 lg:px-5 md:px-5 sm:px-5">
              <div className="flex gap-10 pl-16 md:pl-0">
                <div className="font-mono py-15 px-24 md:px-16 md:text-lg pr-0">
                  <div className="pb-10 text-4xl font-bold flex flex-col justify-center gap-24 md:flex-row md:gap-56">
                      ...
                      <h1 className="font-mono p-4 rounded-xl text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 via-blue-500 to-yellow-100 shadow-lg shadow-cyan-500" style={{ fontSize: '3rem', lineHeight: '4.375rem' }}>Yatin Singh</h1>
                      </div>
                      <div>
              ...
              <div className="flex gap-32 pl-32 sm:pl-0">
            ...
            <div className="pl-32 md:pl-0">
              <motion.section initial = {{opacity : 0 , x:-30}} whileInView={{ opacity: 1, x: 0 }} transition={{duration:2,ease : 'easeOut'}}>
                <section className="text-white px-4 md:px-12 lg:px-24 py-16 max-w-4xl mx-auto font-mono text-left">
                <motion.div initial = {{opacity : 0 , x : -30}} whileInView={{ opacity: 1, x: 0 }} transition={{duration:2,ease : 'easeOut'}}><h2 className="text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-blue-500 mb-8">About Me</h2></motion.div>
                <motion.div initial = {{opacity : 0 , x : -30}} whileInView={{ opacity: 1, x: 0 }} transition={{duration:2,ease : 'easeOut'}}><p className="text-lg leading-8 font-light">
                ...
                <motion.div initial = {{opacity : 0 , x : -30}} whileInView={{ opacity: 1, x: 0 }} transition={{duration:2,ease : 'easeOut'}}>
