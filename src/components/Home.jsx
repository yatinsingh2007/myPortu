      ...
      {loader ? (
        ...
        <motion.main initial={{x:-100,opacity:0}} animate={{x:0,opacity:1}} transition={{duration:1,ease:"easeOut"}}>
          <main className=" text-white h-screen px-3 ">
            <div className="flex flex-col justify-center items-center gap-36 pt-24 lg:gap-48 lg:px-5 md:px-5 sm:px-5">
              <div className="flex gap-10 pl-16 md:pl-0">
                <div className="font-mono py-15 px-24 md:px-16 md:text-lg pr-0">
                  <div className="pb-10 text-4xl font-bold flex flex-col justify-center gap-24 md:flex-row md:gap-56">
                      <motion.div className="flex items-center" initial = {{y : 200}} whileInView={{y : 0}} transition={{duration : 2 , ease : 'easeOut'}}>
                      <h1 className="font-mono p-4 rounded-xl text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 via-blue-500 to-yellow-100 shadow-lg shadow-cyan-500 md:text-7xl text-4xl">Yatin Singh</h1>
                      </motion.div>
                  </div>
                  <div className="text-white px-4 md:px-12 lg:px-24 py-16 max-w-4xl mx-auto font-mono text-left">
                    ...
                    <div>
                        <p className="md:text-2xl text-lg">
                          Passionate about web development, I have solved 130+ questions on LeetCode and
            ...
            <div className="pl-32 md:pl-0">
              <motion.section initial = {{opacity : 0 , x:-100}} whileInView={{ opacity: 1, x: 0 }} transition={{duration:1,ease : 'easeOut'}}>
                ...
                <motion.div initial = {{opacity : 1 , x : -500}} whileInView={{ opacity: 1, x: 0 }} transition={{duration:1,ease : 'easeOut'}}>
                ...
                <motion.div initial = {{opacity : 0 , x : 500}} whileInView={{ opacity: 1, x: 0 }} transition={{duration:1,ease : 'easeOut'}}>
                <p className="text-lg leading-8 font-light mt-6">
                ...
                <motion.div initial = {{opacity : 0 , x : -500}} whileInView={{ opacity: 1, x: 0 }} transition={{duration:1,ease : 'easeOut'}}>
                <p className="md:text-lg md:leading-8 md:font-light mt-6 text-base">
