  ...
  return (
    <div>
      {loader ? (
        ...
        <main className="bg-black text-white h-screen px-3">
          <div className="flex flex-col justify-center items-center gap-36 pt-24">
            <div className="flex gap-10">
              <div className="font-mono py-15 px-24">
              ...
              <div>
                <DotLottieReact
                  src="https://lottie.host/06de52be-25c1-4831-8da1-d09dff65e470/icL5amiw47.lottie"
                  loop
                  autoplay
                  className="w-96"
                />
